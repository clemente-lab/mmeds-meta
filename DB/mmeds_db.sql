...
-- Wed 28 Feb 2018 01:11:15 PM EST
...
CREATE TABLE IF NOT EXISTS `mmeds_db`.`Type` (
  `idType` INT NOT NULL,
  `speciman_type` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`idType`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mmeds_db`.`BodySite` (
  ...
  `BodySite` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_db`.`Specimen` (
  ...
  `SampleDate` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_db`.`SampleProtocol` (
  ...
  `DatePerformed` VARCHAR(45) NULL DEFAULT NULL,
