...
-- Thu 22 Mar 2018 08:54:40 AM EDT
...
-- -----------------------------------------------------
-- Table `mmeds_db`.`Study_has_Subjects`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mmeds_db`.`Study_has_Subjects` ;

CREATE TABLE IF NOT EXISTS `mmeds_db`.`Study_has_Subjects` (
