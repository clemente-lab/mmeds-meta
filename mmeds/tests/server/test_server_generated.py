...
class TestServer(CPWebCase):
    ...
    def test_bc_upload_tsv(self):
        ...
        sub_directories = ['blank_column_tests',
                           'na_column_tests',
                           'other_column_tests',
                           'number_column_tests',
                           'date_column_tests']
    ...
    def run_test_analysis(self):
        ...
        study_name = re.findall('study_name=(.+?)">', body)
        ...
        # Check that it works to access the view_study page
        self.getPage('/analysis/run_analysis?studyName={}&analysis_method=test'.format(study_name[0]),
                     headers + self.cookies, 'POST', body)
        self.assertStatus('200 OK')
        page = server.load_webpage('home',
                                   user=self.server_user,
