...
qiime diversity core-metrics-phylogenetic --i-phylogeny $RUN_Qiime2/rooted_tree.qza --i-table $RUN_Qiime2/filtered_table.qza --p-sampling-depth 1114 --m-metadata-file $RUN_Qiime2/qiime_mapping_file.tsv --p-n-jobs-or-threads 1  --output-dir $RUN_Qiime2/core_metrics_results;
echo "MMEDS_STAGE_3"
...
wait
echo "MMEDS_STAGE_4"
qiime feature-classifier classify-sklearn --i-classifier $test_files/gg-13-8-99-nb-classifier.qza --i-reads $RUN_Qiime2/rep_seqs_dada2.qza --o-classification $RUN_Qiime2/taxonomy.qza --p-n-jobs 1
