...
MODULE_PATH = "/hpc/users/wallad07/www/mmeds-meta/host/__init__.py"
spec = importlib.util.spec_from_file_location("host", MODULE_PATH)
...
#     return cp.Application(mmeds.server.MMEDSserver(watcher, q, testing), '/~wallad07/mmeds-meta/app.wsgi', config=mmeds.config.CONFIG)
# 
# loaded = False
# 
# application = getApp()
