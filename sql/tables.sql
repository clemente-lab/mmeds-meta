...
-- Wed 20 Feb 2019 06:38:05 AM EST
...
-- -----------------------------------------------------
-- Table `mmeds_data1`.`IllnessesCategory`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mmeds_data1`.`IllnessesCategory` ;

CREATE TABLE IF NOT EXISTS `mmeds_data1`.`IllnessesCategory` (
  `idIllnessesCategory` INT NOT NULL,
  `ICDCategory` VARCHAR(3) NULL DEFAULT NULL,
  PRIMARY KEY (`idIllnessesCategory`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `mmeds_data1`.`IllnessesDetails`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mmeds_data1`.`IllnessesDetails` ;

CREATE TABLE IF NOT EXISTS `mmeds_data1`.`IllnessesDetails` (
  `idIllnessesDetails` INT NOT NULL,
  `IllnessesCategory_idIllnessesCategory` INT NOT NULL,
  `ICDDetails` VARCHAR(3) NULL,
  `Extension` VARCHAR(1) NULL,
  PRIMARY KEY (`idIllnessesDetails`),
  INDEX `fk_IllnessesDetails_IllnessesCategory1_idx` (`IllnessesCategory_idIllnessesCategory` ASC),
  CONSTRAINT `fk_IllnessesDetails_IllnessesCategory1`
    FOREIGN KEY (`IllnessesCategory_idIllnessesCategory`)
    REFERENCES `mmeds_data1`.`IllnessesCategory` (`idIllnessesCategory`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Illness` (
  ...
  `Subjects_idSubjects` INT NOT NULL,
  `IllnessesDetails_idIllnessesDetails` INT NOT NULL,
  `user_id` INT NULL DEFAULT NULL,
  ...
  INDEX `fk_Illness_IllnessesDetails1_idx` (`IllnessesDetails_idIllnessesDetails` ASC),
  CONSTRAINT `fk_Illness_Subjects1`
    FOREIGN KEY (`Subjects_idSubjects`)
    REFERENCES `mmeds_data1`.`Subjects` (`idSubjects`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Illness_IllnessesDetails1`
    FOREIGN KEY (`IllnessesDetails_idIllnessesDetails`)
    REFERENCES `mmeds_data1`.`IllnessesDetails` (`idIllnessesDetails`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
