...
-- Fri 26 Oct 2018 02:08:14 PM EDT
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Specimen` (
  ...
  PRIMARY KEY (`idSpecimen`, `Subjects_idSubjects`, `Type_idType`, `Location_idLocation`, `BodySite_idBodySite`, `Experiment_Study_idStudy`, `Experiment_idExperiment`, `Experiment_Study_Lab_idLab`),
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`RawDataProtocols` (
  ...
  `NumberOfContigs` VARCHAR(45) NULL,
