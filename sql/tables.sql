...
-- Wed 28 Aug 2019 08:42:29 AM EDT
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Illness` (
  ...
  `IllnessDescription` VARCHAR(256) NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`SampleProtocols` (
  ...
  `SampleTool` VARCHAR(256) NULL,
  `SampleToolVersion` VARCHAR(256) NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`RawDataProtocols` (
  ...
  `RawDataConditions` VARCHAR(256) NULL,
  `Primer` VARCHAR(256) NULL,
  `TargetGene` VARCHAR(256) NULL,
  `FinishingStrategyStatus` VARCHAR(256) NULL,
  `FinishingStrategyCoverage` VARCHAR(256) NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`RawData` (
  ...
  `BarcodeSequence` VARCHAR(256) NULL,
  `LinkerPrimerSequence` VARCHAR(256) NULL,
  `RawDataDescription` VARCHAR(256) NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`ResultsProtocols` (
  ...
  `ResultsTool` VARCHAR(256) NULL,
  `ResultsToolVersion` VARCHAR(256) NULL,
