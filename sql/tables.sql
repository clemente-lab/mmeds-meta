...
-- Mon 05 Apr 2021 11:44:35 AM EDT
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Strain` (
  ...
  `StrainID` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`SubjectType` (
  ...
  `AnimalSubjects_idAnimalSubjects` INT NULL DEFAULT NULL,
  `Subjects_idSubjects` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `mmeds_data1`.`StorageLocation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mmeds_data1`.`StorageLocation` ;

CREATE TABLE IF NOT EXISTS `mmeds_data1`.`StorageLocation` (
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Specimen` (
  ...
  `SpecimenCollectionMethod` VARCHAR(256) NULL,
  `SpecimenWeight` DECIMAL(18,9) NULL DEFAULT NULL,
  `SpecimenWeightUnit` VARCHAR(45) NULL DEFAULT NULL,
  `SubjectType_idSubjectType` INT NOT NULL,
  `StorageLocation_idStorageLocation` INT NOT NULL,
  ...
  INDEX `fk_Specimen_StorageLocation1_idx` (`StorageLocation_idStorageLocation` ASC))
ENGINE = MEMORY;
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Aliquot` (
  ...
  `AliquotWeightUnit` VARCHAR(45) NULL DEFAULT NULL,
  `StorageLocation_idStorageLocation` INT NOT NULL,
  PRIMARY KEY (`idAliquot`),
  INDEX `fk_Aliquot_Specimen1_idx` (`Specimen_idSpecimen` ASC),
  INDEX `fk_Aliquot_StorageLocation1_idx` (`StorageLocation_idStorageLocation` ASC))
ENGINE = MEMORY;
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`SampleProtocol` (
  ...
  `SampleProtocolNotes` VARCHAR(180) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Sample` (
  ...
  `SampleWeight` DECIMAL(18,9) NULL DEFAULT NULL,
  `SampleWeightUnit` VARCHAR(45) NULL DEFAULT NULL,
  `StorageLocation_idStorageLocation` INT NOT NULL,
  ...
  INDEX `fk_Sample_StorageLocation1_idx` (`StorageLocation_idStorageLocation` ASC))
ENGINE = MEMORY;
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`RawData` (
  ...
  `RawDataNotes` VARCHAR(180) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Housing` (
  ...
  `user_id` INT NULL DEFAULT NULL,
  `TankID` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`HousingDates` (
  ...
  `user_id` INT NULL DEFAULT NULL,
  `HousingStartDate` VARCHAR(45) NULL DEFAULT NULL,
  `HousingEndDate` VARCHAR(45) NULL DEFAULT NULL,
