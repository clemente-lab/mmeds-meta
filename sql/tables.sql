...
-- Wed 26 Feb 2020 08:17:27 AM EST
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`ChowDates` (
  ...
  `ChowEndDate` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`AnimalSubjects` (
  ...
  INDEX `fk_AnimalSubjects_Housing1_idx` (`Housing_idHousing` ASC),
  ...
  CONSTRAINT `fk_AnimalSubjects_Facility1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_AnimalSubjects_Housing1`
