...
-- Thu 27 Feb 2020 08:31:33 AM EST
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Specimen` (
  ...
  PRIMARY KEY (`idSpecimen`, `Specimen_idSpecimen`),
  ...
  INDEX `fk_Specimen_Specimen1_idx` (`Specimen_idSpecimen` ASC),
  CONSTRAINT `fk_Type1`
  ...
  CONSTRAINT `fk_Specimen_SubjectType1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Specimen_Specimen1`
