...
-- Thu 27 Sep 2018 09:28:52 AM EDT
...
CREATE TABLE IF NOT EXISTS `mmeds`.`Specimen` (
  ...
  PRIMARY KEY (`idSpecimen`, `Subjects_idSubjects`, `Type_idType`, `Location_idLocation`, `BodySite_idBodySite`, `Experiment_idExperiment`, `Experiment_Study_idStudy`, `Experiment_Study_Lab_idLab`),
...
CREATE TABLE IF NOT EXISTS `mmeds`.`Subjects_has_Experiment` (
  ...
  `Experiment_Study_idStudy` INT NOT NULL,
  `Experiment_Study_Lab_idLab` INT NOT NULL,
  PRIMARY KEY (`Subjects_idSubjects`, `Experiment_idExperiment`, `Experiment_Study_idStudy`, `Experiment_Study_Lab_idLab`),
  INDEX `fk_Subjects_has_Experiment_Experiment1_idx` (`Experiment_idExperiment` ASC, `Experiment_Study_idStudy` ASC, `Experiment_Study_Lab_idLab` ASC),
