...
-- Mon 25 Feb 2019 12:59:50 PM EST
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`IllnessBroadCategory` (
  ...
  `ICDFirstCharacter` VARCHAR(1) NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Illness` (
  ...
  `IllnessInstanceID` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `mmeds_data1`.`Illness_has_IllnessDetails`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mmeds_data1`.`Illness_has_IllnessDetails` ;

CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Illness_has_IllnessDetails` (
  `Illness_idIllness` INT NOT NULL,
  `IllnessDetails_idIllnessDetails` INT NOT NULL,
  PRIMARY KEY (`Illness_idIllness`, `IllnessDetails_idIllnessDetails`),
  INDEX `fk_Illness_has_IllnessDetails_IllnessDetails1_idx` (`IllnessDetails_idIllnessDetails` ASC),
  INDEX `fk_Illness_has_IllnessDetails_Illness1_idx` (`Illness_idIllness` ASC),
  CONSTRAINT `fk_Illness_has_IllnessDetails_Illness1`
    FOREIGN KEY (`Illness_idIllness`)
    REFERENCES `mmeds_data1`.`Illness` (`idIllness`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Illness_has_IllnessDetails_IllnessDetails1`
