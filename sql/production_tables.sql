...
-- Wed 31 Mar 2021 09:33:41 AM EDT
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Specimen` (
  ...
  `SpecimenWeightUnit` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Intervention` (
  ...
  `user_id` INT NULL DEFAULT NULL,
  `InterventionDescription` VARCHAR(180) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Aliquot` (
  ...
  `AliquotWeightUnit` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `mmeds_data1`.`Sample` (
  ...
  `SampleWeight` DECIMAL(18,9) NULL,
  `SampleWeightUnit` VARCHAR(45) NULL,
