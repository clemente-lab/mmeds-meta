...
DROP VIEW IF EXISTS `mmeds_data1`.`protected_Housing`;
CREATE
SQL SECURITY DEFINER
VIEW `mmeds_data1`.`protected_Housing` AS
SELECT cc.* FROM `mmeds_data1`.`Housing` cc WHERE `mmeds_data1`.owner_check(cc.user_id)
WITH CHECK OPTION;

GRANT SELECT ON TABLE `mmeds_data1`.`protected_Housing` TO 'mmedsusers'@%;
...
GRANT SELECT ON TABLE `mmeds_data1`.`SubjectType` TO 'mmedsusers'@%;
...
GRANT SELECT ON TABLE `mmeds_data1`.`Husbandry` TO 'mmedsusers'@%;
...
INSERT INTO `AnimalSubjects` VALUES (1, NULL, 1, 1, 1, 1, NULL, NULL, 1, 1);

INSERT INTO `SubjectType` VALUES (1, NULL, 1, 1);
...
INSERT INTO `ChowDates` VALUES (1, NULL, NULL, 1);
...
INSERT INTO `Housing` VALUES (1, NULL, NULL, NULL, NULL, NULL, NULL);

INSERT INTO `Husbandry` VALUES (1, NULL, NULL, NULL, NULL);
